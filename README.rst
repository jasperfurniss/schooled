...
.. code-block:: bash
    ...
    cd schooled
    celery -A schooled.taskapp worker -l info
...
To run the tests, enter the schooled/tests directory and run the following commands::
